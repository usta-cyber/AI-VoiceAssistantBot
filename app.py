...
def main():
    ...
    print("AI Assistant:{}".format("Processing output"))
    try:
        while True:
            ...
            if not record_audio_chunk(audio, stream):
                ...
                #transcription = transcribe_audio_sr(chunk_file)

                os.remove(chunk_file)
                print("Customer:{}".format("Audio Processing"))
                
                # Add customer input to transcript
                customer_input_transcription += "Customer: " + "Audio Processing" + "\n"
